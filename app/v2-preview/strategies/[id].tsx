...
const styles = StyleSheet.create({
  ...
  updatedAt: { color: V2.textDim, fontSize: 10 },
  ...
  tagText: { color: V2.textMuted, fontSize: 10, fontWeight: "700" },
  ...
  primaryButtonText: { color: V2.background, fontSize: 12, fontWeight: "900" },
  ...
  secondaryButtonText: { color: V2.text, fontSize: 12, fontWeight: "800" },
  ...
  cell: { minWidth: 74, fontSize: 11, lineHeight: 16 },
  ...
  bottomNoticeText: { flex: 1, color: V2.textMuted, fontSize: 11, lineHeight: 18 },
