...
> 当前 `main` 的 EAXAU V2 已是根首页。六策略、Managed Session、USDT EA 结算的真实能力与上线门槛，统一以 [`docs/eaxau-v2/README.md`](docs/eaxau-v2/README.md) 为准。DEMO 数据不得对外表述为实盘。

**一个面向 MT4/MT5 六策略展示、限时资管会话与 EA 交付的平台。**
...
`Quant Trading Hub` 是 EAXAU 的移动 + Web 应用代码库，用于六策略数据展示、限时资管会话、券商执行槽配置与 EA 商品交付。页面必须根据数据源明确标记 `DEMO/CUSTOM/LIVE/HYBRID`。
