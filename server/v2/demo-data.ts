...
export const DEMO_STRATEGIES: CoreStrategy[] = [
  buildStrategy({
    ...
    compatiblePlatformIds: ["exness", "ic-markets", "blueberry-markets"],
    seed: 1,
  }),
  buildStrategy({
    id: "night-hunter",
...
export const DEMO_PLATFORMS: PlatformProfile[] = [
  {
    ...
    name: "Exness",
    code: "EX",
    entity: "实际签约实体以客户开户页为准",
    regionLabel: "可用地区待核验",
    terminals: ["MT4", "MT5"],
    minimumCapital: 0,
    accountType: "账户类型请在官方客户区核验",
    summary: "AI量化联盟可选券商；可用地区、账户实体与入金方式以官方客户区为准。",
    ...
    commercialTerms: {
      version: "OFFICIAL-PORTAL-CHECK-2026.08",
      effectiveFrom: "2026-08-24",
      spreadLabel: "按官方实时账户条件核验",
      commissionLabel: "按官方账户类型核验",
      rebateLabel: "未在平台公开保证",
      rebateEligibility: "开户实体、地区与账户类型均需核验",
      withdrawalP50Hours: null,
      withdrawalP95Hours: null,
      withdrawalSampleSize: 0,
  ...
  },
  {
    ...
    minimumCapital: 0,
    accountType: "账户类型请在官方客户区核验",
    summary: "AI量化联盟可选券商；USDT 通道条件会变动，下单前需在官方客户区确认。",
    supportedStrategyIds: [
      "jingge-v51",
      "night-hunter",
      "quantum-queen",
  ...
  },
  {
    ...
    minimumCapital: 0,
    accountType: "账户类型请在官方客户区核验",
    summary: "AI量化联盟可选券商；USDT 可用性按地区和通道动态核验。",
    supportedStrategyIds: [
      "jingge-v51",
      "quantum-queen",
      "gold-reaper",
...
export const DEMO_ACCOUNTS: ServiceAccount[] = [
  ...
  },
  {
    ...
    contractStatus: "NONE",
    platformIds: ["exness", "ic-markets", "blueberry-markets"],
    strategyIds: [
      "jingge-v51",
      "night-hunter",
      "quantum-queen",
